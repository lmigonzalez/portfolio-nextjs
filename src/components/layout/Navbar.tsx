    ...
    >
      ...
      >
        ...
        <ul className="hidden md:flex items-center text-xl space-x-6 font-light">
          <li
            className={`${
              currentRoute === "/" ? "text-orange_color" : ""
          ...
          <li
            className={`${
              currentRoute === "/services" ? "text-orange_color" : ""
            } cursor-pointer hover:text-orange_color transition-colors`}
          >
          ...
          <li
            className={`${
              currentRoute === "/projects" ? "text-orange_color" : ""
            } cursor-pointer hover:text-orange_color transition-colors`}
          >
          ...
          <li
            className={`${
              currentRoute === "/about" ? "text-orange_color" : ""
            } cursor-pointer hover:text-orange_color transition-colors`}
          >
          ...
          <li
            className={`${
              currentRoute.startsWith("/blog") ? "text-orange_color" : ""
            } cursor-pointer hover:text-orange_color transition-colors`}
          >
        ...
        <button
          ...
          className={`${
            showMenu ? "fixed top-2 right-4" : "block relative"
          } md:hidden w-12 h-12 bg-orange_color rounded-full z-50`}
        >
          <div
