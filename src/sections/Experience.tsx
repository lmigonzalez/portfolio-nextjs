  ...
  return (
    <div className="py-16  m-auto flex flex-col items-center w-[1400px] max-w-full px-4">
      ...
      <div className="flex items-center relative  w-full h-[600px] m-auto mb-16">
        ...
        <div className="w-1/2 flex flex-col justify-between h-[500px] pl-4">
          ...
          <div className="w-full h-20">
            ...
            <p className="font-medium">Junior Software Developer</p>
            <p className="text-xs">Nov 2021 - Present</p>
          </div>
        </div>
        <div className="w-1/2 flex items-center justify-between h-[500px] pr-4">
          <div className="w-full h-20 text-end">
            ...
            <p className="font-medium">Full Stack Web Developer</p>
            <p className="text-xs">May 2022 - Jan 2023</p>
          </div>
        </div>
      </div>
